...
namespace TRueBalance.Migrations
{
    ...
    [Migration("20181018234452_AddCategoriesToOrdersTakeAway")]
    partial class AddCategoriesToOrdersTakeAway
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("placeMT.Data.Entities.Invoice", b =>
                {
                    ...
                    b.Property<int?>("PaymentTypeCategoryID");
                    ...
                    b.HasIndex("PaymentTypeCategoryID");
            ...
            modelBuilder.Entity("placeMT.Data.Entities.Order", b =>
                {
                    ...
                    b.Property<int?>("TakeawayCategoryID");

                    b.HasKey("OrderID");

                    b.HasIndex("TakeawayCategoryID");
            ...
            modelBuilder.Entity("placeMT.Data.Entities.Product", b =>
                {
            ...
            modelBuilder.Entity("placeMT.Data.Entities.Sell", b =>
                {
            ...
            modelBuilder.Entity("placeMT.Data.Entities.Invoice", b =>
                {
                    b.HasOne("PlaceMT.Data.Entities.Category", "PaymentType")
                        .WithMany()
                        .HasForeignKey("PaymentTypeCategoryID");
                });
            ...
            modelBuilder.Entity("placeMT.Data.Entities.Order", b =>
                {
                    b.HasOne("PlaceMT.Data.Entities.Category", "Takeaway")
                        .WithMany()
                        .HasForeignKey("TakeawayCategoryID");
                });
            ...
            modelBuilder.Entity("PlaceMT.Data.Entities.PrintQueue", b =>
                {
                    b.HasOne("placeMT.Data.Entities.Invoice", "LinkedInvoice")
                        .WithMany()
            ...
            modelBuilder.Entity("placeMT.Data.Entities.Sell", b =>
                {
                    b.HasOne("placeMT.Data.Entities.Invoice")
